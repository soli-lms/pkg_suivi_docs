Donnez definition du problem personaliser au ce pkg_suivi_competences qui exciste dans le (Package 2 : Interface Formateur) pour cette application (Soli-LMS) sans detail .

description pkg_suivi_competences : ils perme formateur de suivi l'avancement de competences en ce form du tablequ ou chart graphic
