Donnez l'empathie personaliser au ce pkg_suivi_competences qui exciste dans le (Package 2 : Interface Formateur) pour cette application (Soli-LMS) pour chaque acteur (apprenant, formateur, responsable de formation).
donner les parties:
- Ce qu'il dit.
- Ce qu'il fait.
- Ce qu'il ressent.
...
Répondez en français pour un enfant de dix ans .
